...
- Added `create_document_from_tabular()` function to create RSpace
  documents directly from R data.frames/tibbles.
- Added
  [`document_get_fields()`](https://lacdr.github.io/rspacer/reference/document_get_fields.md)
  function to retrieve the field contents of a given RSpace document.
- [`document_list_attachments()`](https://lacdr.github.io/rspacer/reference/document_list_attachments.md)
  function now returns all attachments instead of just for a given
  field.
- Fixed: Uploading a document without template id now keeps section
  headings.
...
- Add
  ...
  function to convert RSpace document fields to a tibble.
